...
print("test fabulous " + str(prefixtrees.searchword(T,"fabulous")))
print("test Fam " + str(prefixtrees.searchword(T,"Fam")))
print("test caste " + str(prefixtrees.searchword(T,"CASte")))
print()
...
prefixtrees.treetofile(B , "test3.txt")
C = prefixtrees.treefromfile("dic2.txt")
prefixtrees.treetofile(C , "test.txt")
